...
ngAfterViewInit() {
  ...
  polygonTemplate.events.on("hit", (ev) => {
      ...
      this.http.get(url , httpOptions).subscribe(data =>{
        ...
        console.log(test[Object.keys(test)[672]]);
        this.totalCasesByCountry = test[Object.keys(test)[672]].total_cases;
        this.totalDeathsByCountry = test[Object.keys(test)[672]].total_deaths;
        this.totalRecoveredByCountry = test[Object.keys(test)[672]].total_recovered;
        this.totalCasesCountryName = test[Object.keys(test)[672]].country_name;
      }) 
